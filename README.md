...
* Compile WowPacketParser using Visual Studio 2026 (with .NET 10.0 SDK) or .NET 10.0 SDK.
...
[Download .NET 10.0 here!](https://dotnet.microsoft.com/download/dotnet/10.0)
